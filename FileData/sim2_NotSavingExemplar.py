    ...
    if OUTPUT == "y":
        ...
        while True:
            ...
            for lines in MASTER_CONCEPT_LIST:
                ...
                if query in lines or reverseQuery in lines:
        ...
        #print "Defuzz value:", complete_concept.attributes['size'].defuzzify()
            ...
            OutPutFile = open("FromVisuoToDisplay.txt", "r+")
            OutPutFile.seek(0,2)
            OutPutFile.write(splittedquery[0][1:-1]+"-"+splittedquery[2]+" "+str(resultsToReturn[0])+" "+str(resultsToReturn[1])+" \n")#ex: an-sky 102.3 0.34
            OutPutFile.close()
