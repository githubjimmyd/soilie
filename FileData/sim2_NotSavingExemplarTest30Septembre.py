...
def create_examples(filename):
    ...
    picklingfile = open("..\SaveData\saveDataTest.txt", "wb")
...
if __name__ == '__main__':
    ...
    if loadOrNot == "y":
        ...
        picklingfile = open("..\SaveData\save2.txt", "rb")
        Prototype.concept_list = cPickle.load(picklingfile)
        picklingfile.close()
        i = 2
##        while (i < 25):
##            picklingfile = open("..\SaveData\save2.txt", "rb")   ##To change the name of the file, change the input() to the name of the file you wish to load in between ""
...
##        picklingfile = input()
    ...
    TRAINING = "y"						## Do we wish to train visuo on dataset y or n
    if TRAINING == "y":
        #print("Please input examplefile name.")
        EXAMPLE_FILE = "..\TrainData\TrainDataTest2.txt"				## Input the name of the file containing said dataset
        #print('Would you like to get the output?')
        OUTPUT = "y"									## Do we want an output distribution?
